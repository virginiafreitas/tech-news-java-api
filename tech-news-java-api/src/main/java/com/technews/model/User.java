...
import com.technews.VariablesPractice;
...
public class User implements Serializable {
    ...
    @Transient
    boolean loggedIn;
    @OneToMany(mappedBy = "userId", cascade = CascadeType.ALL, fetch = FetchType.EAGER, targetEntity = Post.class)
    private List<Post> posts;

    // Need to use FetchType.LAZY to resolve multiple bags exception
    @OneToMany(mappedBy = "userId", cascade = CascadeType.ALL, fetch = FetchType.LAZY, targetEntity = Vote.class)
